...
async function getDatabase() {
    ...
    // Seed users and initial tasks if the database is empty
...
// Simple Local Database of Users
const USERS = {
    raja: { password: 'raja', name: 'Raja' },
    vani: { password: 'vani', name: 'Vani' }
};
...
async function seedDatabase(dbInstance) {
    try {
        ...
        const tasksCollection = dbInstance.collection('tasks');
